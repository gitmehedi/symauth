...
use SystemUsersBundle\Entity\Roles;
use SystemUsersBundle\Form\RolesType;
...
class RolesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SystemUsersBundle:Roles')->findAll();

        return $this->render('SystemUsersBundle:Roles:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SystemUsersBundle:Roles:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SystemUsersBundle:Roles')->find($id);
        ...
        return $this->render('SystemUsersBundle:Roles:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SystemUsersBundle:Roles:edit.html.twig', array(
            'entity'      => $entity,
